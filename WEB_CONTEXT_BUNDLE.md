...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-827-coloring-random-subgraphs-875e63b3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-827"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-827-coloring-random-subgraphs-875e63b3-v1",
      "problem_contract_sha256": "d68958a217a78183da76244394d69010c19c1601b1986b23f8f897bd3c57f8d5",
      "problem_id": "problem:um-opg-827-coloring-random-subgraphs-875e63b3",
      "route_id": "route:um-opg-827-coloring-random-subgraphs-875e63b3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-827-coloring-random-subgraphs-875e63b3-source-fidelity-01",
      "graph_id": "graph:um-opg-827-coloring-random-subgraphs-875e63b3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-827-coloring-random-subgraphs-875e63b3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-827-coloring-random-subgraphs-875e63b3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If $G$ is a graph and $p \\in [0,1]$, we let $G_p$ denote a subgraph of $G$ where each edge of $G$ appears in $G_p$ with independently with probability $p$. Problem Does there exist a constant $c$ so that ${\\mathbb E}(\\chi(G_{1/2})) > c \\frac{\\chi(G)}{\\log \\chi(G)}$?"
          },
          "statement_sha256": "30c6af29906319d844b615d2ebf68da93934531294fb853af66c497c2acffb05"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-827-coloring-random-subgraphs-875e63b3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-827-coloring-random-subgraphs-875e63b3-root",
      "route_id": "route:um-opg-827-coloring-random-subgraphs-875e63b3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-827-be16e1939255",
        "url": "https://www.unsolvedmath.com/problems/OPG-827"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
